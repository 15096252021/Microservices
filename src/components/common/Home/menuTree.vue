...
import josnTest from '@/mock/json/menuTree.json';
...
export default defineComponent({
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            //     });
            //     // dynamicRouterStore.UpdateMenuList(josnTest);
            //     console.log(josnTest);
            // }
            console.log(josnTest);
            dynamicRouterStore.UpdateMenuList(josnTest.data as Array<menuItem>);
